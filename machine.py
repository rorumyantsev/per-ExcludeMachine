...
SDD_ZONE_LINK = r"https://raw.githubusercontent.com/rorumyantsev/per-ExcludeMachine/main/Per-SDD.geojson.json"
sdd_geometry = json.loads(open('Per-SDD.geojson.json').read())
sdd_polygon: Polygon = shapely.geometry.shape(sdd_geometry)

NDD_NEAR_ZONE_LINK = r"https://raw.githubusercontent.com/rorumyantsev/per-ExcludeMachine/main/NDD_close.geojson"
...
NDD_FAR_ZONE_LINK = r"https://raw.githubusercontent.com/rorumyantsev/per-ExcludeMachine/main/NDD_far.geojson"
